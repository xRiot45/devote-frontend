...
import { useFetchVotingResult } from '@/hooks/voting-result/useFetchVotingResult';
...
export default function VotingResultsPage() {
    ...
    const { data, isPending } = useFetchVotingResult();
    const votingResultData = data?.data;
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Voting Result" />
            </Head>
            <div className="mb-2 flex flex-wrap justify-between space-y-2 mt-6 p-2">
                <div>
                    <h1 className="text-2xl font-semibold tracking-tight ">Voting Result</h1>
                    <p className="text-muted-foreground mt-1.5 text-[14px]">Manage and control voting result</p>
                </div>
                                    ...
                                    <TooltipProvider>
                                        ...
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <Link href={`/admin/voting-results/${proposal.id}/show`}>
                                                    <Button
                                                        size="icon"
                                                        variant="ghost"
